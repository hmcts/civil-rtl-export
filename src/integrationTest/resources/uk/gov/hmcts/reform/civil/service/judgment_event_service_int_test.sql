...
VALUES
(nextval('jud_seq'), 'IT01', '4004-1', to_timestamp('2024-04-04 04:00:00', 'YYYY-MM-DD HH24:MI:SS'), '123',
 '40000004', '0AA40004', 44.0, to_date('2024-04-04', 'YYYY-MM-DD'), 'R',
 'Jud4Def1FirstName Jud4Def1LastName', 'Jud4Def1 Address Line 1', 'JD4 1DD');
...
(id, service_id, judgment_id, judgment_event_timestamp, court_code,
 ...
 defendant_name, defendant_address_line_1, defendant_address_postcode)
VALUES
(nextval('jud_seq'), 'IT01', '5005-2', to_timestamp('2024-05-05 05:00:00', 'YYYY-MM-DD HH24:MI:SS'), '123',
 '50000005', '0AA50005', 55.0, to_date('2024-05-05', 'YYYY-MM-DD'), 'R',
 'Jud5Def2FirstName Jud5Def2LastName', 'Jud5Def2 Address Line 1', 'JD5 2DD');
...
(id, service_id, judgment_id, judgment_event_timestamp, court_code,
 ...
 defendant_name, defendant_address_line_1, defendant_address_postcode)
VALUES
(nextval('jud_seq'), 'IT01', '7007-2', to_timestamp('2024-07-07 07:00:00', 'YYYY-MM-DD HH24:MI:SS'), '123',
 '70000007', '0AA70007', 77.0, to_date('2024-07-07', 'YYYY-MM-DD'), 'R',
 'Jud7Def2FirstName Jud7Def2LastName', 'Jud7Def2 Address Line 1', 'JD7 2DD');
