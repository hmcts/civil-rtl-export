...
-- Create indices
------------------------------------------------
CREATE UNIQUE INDEX jud_ind_pk ON judgements (id);


------------------------------------------------
-- Create Primary Keys
------------------------------------------------
ALTER TABLE judgements ADD CONSTRAINT jud_pk PRIMARY KEY USING INDEX jud_ind_pk;
...
ALTER TABLE judgements ADD CONSTRAINT j_jud_adm_ord_dat_nn CHECK (judgement_admin_order_date IS NOT NULL);
